...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/4IceG/luci-app-mini-diskmanager?style=flat-square)
![GitHub stars](https://img.shields.io/github/stars/4IceG/luci-app-mini-diskmanager?style=flat-square)
![GitHub forks](https://img.shields.io/github/forks/4IceG/luci-app-mini-diskmanager?style=flat-square)
![GitHub All Releases](https://img.shields.io/github/downloads/4IceG/luci-app-mini-diskmanager/total)
...
> ***Required Packages:***
> 
> luci-base, block-mount, fdisk, parted, lsblk
...
![](https://github.com/4IceG/Personal_data/blob/master/zrzuty/mini-diskmanager/Disk%20Manager%204.png?raw=true)

![](https://github.com/4IceG/Personal_data/blob/master/zrzuty/mini-diskmanager/Disk%20Manager%206.png?raw=true)
